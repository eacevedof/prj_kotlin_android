    ...
    Scaffold(
        ...
        floatingActionButton = { // Add FAB
            FloatingActionButton(onClick = {
                val intent = Intent(context, CreateUserActivity::class.java) // Use the context
...
fun UserCard(user: User) {
    Card(
        ...
        Column(
            ...
            Text(text = "Fecha de Nacimiento: ${SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).format(user.birthDate)}", style = MaterialTheme.typography.bodyMedium)
...
fun UserListPreview() {
    ...
    val sampleUsers = listOf(
        User(name = "John Doe", birthDate = Date(), email = "john.doe@example.com", phone = "1234567890", username = "johndoe", accessPassword = "password"),
        User(name = "Jane Smith", birthDate = Date(), email = "jane.smith@example.com", phone = "9876543210", username = "janesmith", accessPassword = "password")
    )
